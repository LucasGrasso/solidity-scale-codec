...
- ef94482: Add barrel exports for v3 and v5, and rename conflicting structs. `TrapParams` in `XcmError` renamed to `TrapErrorParams` and `IndexParams` in `BodyId` renamed to `BodyIndexParams`
...
- 4f65bbc: Changes Imports to import from definition, not from barrel
- ac0dd5a: Run format
- 3145716: Run format
...
- Typo in `Definitions` documentation - [#0b255f7](https://github.com/LucasGrasso/solidity-scale-codec/commit/0b255f7)

## Version 3.0.1

### Fixed

- Fix links in `README.md` - [#e7fb53f](https://github.com/LucasGrasso/solidity-scale-codec/commit/e7fb53f)
