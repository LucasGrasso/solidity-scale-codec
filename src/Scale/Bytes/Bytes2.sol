...
library Bytes2 {
    ...
    /// @notice Returns the number of bytes that a `bytes2` struct would occupy when SCALE-encoded.
	...
	/// @return The number of bytes that the `bytes2` struct would occupy when SCALE-encoded.
